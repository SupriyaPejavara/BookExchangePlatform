...
namespace BEP.Application.Common
{
     public static class DataInitializer
     {
          public static void SeedDatabase(BEPDbContext context, IMediator mediator)
          {
               ...
               if (!context.Users.Any())
               {
                    var user1 = new User
                    {
                         ...
                         Points = 10,
                         IdentityId = "1",
                         UserContact = new UserContact { Email = "supriyapejavar@gmail.com" }
                    };
                    ...
                    var user2 = new User
                    {
                         ...
                         Points = 5,
                         IdentityId = "2",
                         UserContact = new UserContact { Email = "spejavara@gmail.com" },
                    };
                    var user3 = new User
                    {
                         ...
                         Points = 5,
                         IdentityId = "3",
                         UserContact = new UserContact { Email = "akshaya9579@gmail.com" },
                    };
